...
while True:
    ...
    while frog.lives > 0:
        ...
        text_info1 = info_font.render(('Level: {0}               Points: {1}'.format(game.level, game.points)), 1,
                                      (255, 255, 255))
        text_info2 = info_font.render(('Time: {0}           Lifes: {1}'.format(game.time, frog.lives)), 1,
                                      (255, 255, 255))
        screen.blit(background, (0, 0))
    ...
    while gameInit == 1:
        ...
        text_reiniciar = info_font.render('Good luck next time!', 1, (255, 0, 0))
